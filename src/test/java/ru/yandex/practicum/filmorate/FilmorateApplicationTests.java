...
import ru.yandex.practicum.filmorate.dao.service.FriendsDbService;
import ru.yandex.practicum.filmorate.dao.service.RateDbService;
...
class FilmorateApplicationTests {
    ...
    private final RateDbService rateService;
    private final FriendsDbService friendsService;
    ...
    public void testDb() throws Throwable {
        ...
        List<Integer> findUserRateFilmAdd = rateService.findUserRateFilm(film.getId());
        ...
        List<Integer> findUserRateFilmRemove = rateService.findUserRateFilm(film.getId());
